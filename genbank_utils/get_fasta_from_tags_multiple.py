'''
Read a text list of locus tags and get them from .gbks in a directory. Works with multiple loci per genome.
For single loci, get_fasta_from_genbank.py is much faster!
		...
		for feature in record.features:
			try:
				if feature.qualifiers['locus_tag'][0] in annotations:
					...
					sequences.append([name, dna_sequence, protein_sequence])
			except:
				pass
	return sequences
